...
extension API.Method.Items {
    ...
    /// Получение записей
    @discardableResult
    static func list(appId: String, token: String, completionHandler completion: @escaping (_ data: () throws -> API.Model.Items.ListResponseModel) -> Void) -> Request {
        return API.Method.requestBuilder(resource: .listsList, appId: appId, token: token, completionHandler: completion)
    }
    
    /// Создание записи
    @discardableResult
    static func create(requestData data: API.Model.Items.CreateRequestModel, appId: String, token: String, completionHandler completion: @escaping (_ data: () throws -> API.Model.Items.CreateResponseModel) -> Void) -> Request {
    ...
    /// Удаление записи
    @discardableResult
    static func delete(requestData data: API.Model.Items.DeleteRequestModel, appId: String, token: String, completionHandler completion: @escaping (_ data: API.Method.VoidResponse) -> Void) -> Request {
